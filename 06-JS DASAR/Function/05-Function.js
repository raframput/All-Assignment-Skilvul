...
function taxCalc(salary) { 
    if(salary < 5000000){
     ...
     let pajak = salary * 0.05 
    return pajak 
  
    }else if (10000000 < salary < 20000000) {
      let pajak = salary * 0.1
      return pajak
  
    }else if(20000000 < salary) {
      let pajak = salary * 0.2
      return pajak
    }
  ...
  function convToUpperCase(sentence) { 
    ...
    for (let index = 0; index < firstChart.length; index++) {
        change = firstChart[index].toUpperCase()
         firstChart[index] = change.charAt(0) + firstChart[index].substring(1)
    }
      let firstChart1 = ""; 
      for (let index = 0; index < firstChart.length; index++) {
